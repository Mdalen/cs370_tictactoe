	...
	//else
		...
		for(var i=0;i<9;i++){
			...
			if(boardCopy[i]==0){
				...
				var possibleMove = recursMin(boardCopy);
	...
	//else
		...
		for(var i=0;i<9;i++){
			...
			if(boardCopy[i]==0){
				...
				var possibleMove = recursMax(boardCopy);
...
function getMove(){
	...
	for(var i=0;i<9;i++){
		...
		if(boardCopy[i]==0){
			...
			boardCopy[i] = 1;
			var currentVal = recursMin(boardCopy);
