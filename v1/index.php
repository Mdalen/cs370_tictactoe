...
<html lang="en">
	<head>
		<title>M-Dalen CS 370 Assignment 3 Problem 1</title>
		<!--metadata-->
		<meta charset="utf-8">
	...
	<body>
		...
		<!--create the label-->
			<div class="row">
				...
				<div class="col-sm-10"><div class="alert alert-success text-center" id="signature">Mitchell Dalen - Tic Tac Toe Game - Version #1</div></div>
				<div class="col-sm-1"></div>
			</div>
